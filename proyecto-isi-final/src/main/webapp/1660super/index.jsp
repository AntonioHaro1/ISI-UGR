...
<body>
    <div class="Cabecera">
        <div class="Imagen">
            <img src="../imgs/1660super.jpg" alt="Tarjetas gráficas" width=440px height=255px>
            <h2>NVIDIA GEFORCE GTX 1660 SUPER</h2>
        </div>
        ...
        <%
        	...
        	tg.setNombre("nvidia gtx 1660 super");
        	
        	VersusComparador vs = new VersusComparador(tg);
        	
        	tg.setCaracteristicas(vs.CaracteristicasBusqueda("https://versus.com/en/nvidia-geforce-gtx-1660-super"));
    ...
    <div class="Precio">
        <div>
            ...
            <h2>Precio Amazon</h2>
            <%
            	Amazon amazon = new Amazon("1660super");
        ...
        <div>
            ...
            <%
            	...
            	preciosEbay = ebay.EbayBusqueda("https://www.ebay.es/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=1660+super&_sacat=0&LH_TitleDesc=0&_odkw=2060&_osacat=0");
        ...
        <div>
            ...
            <%
            	...
            	precio = versus.VsBusqueda("https://www.vsgamers.es/product/tarjeta-grafica-nvidia-geforce-gtx-1660-super-6-gb-gddr6-twin-fan");
