...
<body>
    <div class="Cabecera">
        <div class="Imagen">
            <img src="../imgs/2060.jpg" alt="Tarjetas gráficas" width=440px height=255px>
            <h2>NVIDIA GEFORCE RTX 2060</h2>
        </div>
        ...
        <%
        	...
        	tg.setCaracteristicas(vs.CaracteristicasBusqueda("https://versus.com/en/nvidia-geforce-rtx-2060"));
    ...
    <div class="Precio">
        <div>
            ...
            <h2>Precio Amazon</h2>
            <%
            	Amazon amazon = new Amazon("nvidia rtx 2060");
        ...
        <div>
            ...
            <%
            	...
            	preciosEbay = ebay.EbayBusqueda("https://www.ebay.es/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=2060&_sacat=0&LH_TitleDesc=0&_odkw=2060super&_osacat=0");
        ...
        <div>
            ...
            <%
            	...
            	precio = versus.VsBusqueda("https://www.vsgamers.es/product/tarjeta-grafica-asus-dual-geforce-rtx-2060-evo-6-gb-gddr6");
