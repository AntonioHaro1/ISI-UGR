...
<body>
    <div class="Cabecera">
        <div class="Imagen">
            <img src="../imgs/3060.jpg" alt="Tarjetas grÃ¡ficas" width=440px height=255px>
            <h2>NVIDIA GEFORCE RTX 3060</h2>
        </div>
        ...
        <%
        	...
        	tg.setCaracteristicas(vs.CaracteristicasBusqueda("https://versus.com/en/nvidia-geforce-rtx-3060"));
    ...
    <div class="Precio">
        ...
        <div>
            ...
            <%
            	...
            	preciosEbay = ebay.EbayBusqueda("https://www.ebay.es/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=3060&_sacat=0&LH_TitleDesc=0&_odkw=3070ti&_osacat=0");
        ...
        <div>
            ...
            <%
            	...
            	precio = versus.VsBusqueda("https://www.vsgamers.es/product/tarjeta-grafica-asus-dual-geforce-rtx-3060-12gb-v2-gddr6");
