...
<body>
    <div class="Cabecera">
        <div class="Imagen">
            <img src="../imgs/3090ti.jpg" alt="Tarjetas gráficas" width=440px height=255px>
            <h2>NVIDIA GEFORCE RTX 3090</h2>
        </div>
        ...
        <%
        	...
        	tg.setCaracteristicas(vs.CaracteristicasBusqueda("https://versus.com/en/nvidia-geforce-rtx-3090"));
    ...
    <div class="Precio">
        ...
        <div>
            ...
            <%
            	...
            	preciosEbay = ebay.EbayBusqueda("https://www.ebay.es/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=3090&_sacat=0&LH_TitleDesc=0&_odkw=3090ti&_osacat=0");
        ...
        <div>
            ...
            <%
            	...
            	precio = versus.VsBusqueda("https://www.vsgamers.es/product/tarjeta-grafica-asus-rog-strix-geforce-rtx-3090-24-gb-gddr6x-blanca");
