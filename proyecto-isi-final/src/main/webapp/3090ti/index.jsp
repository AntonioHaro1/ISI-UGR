...
<body>
    <div class="Cabecera">
        <div class="Imagen">
            ...
            <h2>NVIDIA GEFORCE RTX 3090 TI</h2>
        </div>
        ...
        <%
        	...
        	tg.setNombre("nvidia rtx 3090ti");
        	
        	VersusComparador vs = new VersusComparador(tg);
        	
        	tg.setCaracteristicas(vs.CaracteristicasBusqueda("https://versus.com/en/nvidia-geforce-rtx-3090-ti"));
    ...
    <div class="Precio">
        <div>
            ...
            <h2>Precio Amazon</h2>
            <%
            	Amazon amazon = new Amazon("3090ti");
        ...
        <div>
            ...
            <%
            	...
            	preciosEbay = ebay.EbayBusqueda("https://www.ebay.es/sch/i.html?_from=R40&_trksid=p2380057.m570.l1313&_nkw=3090ti&_sacat=0");
        ...
        <div>
            ...
            <%
            	...
            	precio = versus.VsBusqueda("https://www.vsgamers.es/product/tarjeta-grafica-asus-tuf-gaming-geforce-rtx-3090-ti-oc-24g-24-gb-gddr6x");
