...
<body>
    <div class="Cabecera">
        <div class="Imagen">
            <img src="../imgs/3080.jpg" alt="Tarjetas grÃ¡ficas" width=440px height=255px>
        ...
        <%
        	...
        	tg.setCaracteristicas(vs.CaracteristicasBusqueda("https://versus.com/en/nvidia-geforce-rtx-3080"));
    ...
    <div class="Precio">
        <div>
            ...
            <h2>Precio Amazon</h2>
            <%
            	Amazon amazon = new Amazon("Nvidia Geforce RTX 3080");
        ...
        <div>
            ...
            <%
            	...
            	preciosEbay = ebay.EbayBusqueda("https://www.ebay.es/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=3080&_sacat=0&LH_TitleDesc=0&_odkw=3080+ti&_osacat=0");
        ...
        <div>
            ...
            <%
            	...
            	precio = versus.VsBusqueda("https://www.vsgamers.es/product/tarjeta-grafica-asus-tuf-gaming-geforce-rtx-3080-oc-gaming-lhr");
