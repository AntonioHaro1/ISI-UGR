...
<body>
    <div class="Cabecera">
        <div class="Imagen">
            <img src="../imgs/3070.jpg" alt="Tarjetas grÃ¡ficas" width=440px height=255px>
            <h2>NVIDIA GEFORCE RTX 3070</h2>
        </div>
        ...
        <%
        	...
        	tg.setCaracteristicas(vs.CaracteristicasBusqueda("https://versus.com/en/nvidia-geforce-rtx-3070"));
    ...
    <div class="Precio">
        <div>
            ...
            <h2>Precio Amazon</h2>
            <%
            	Amazon amazon = new Amazon("Nvidia RTX 3070");
        ...
        <div>
            ...
            <%
            	...
            	preciosEbay = ebay.EbayBusqueda("https://www.ebay.es/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=3070&_sacat=0&LH_TitleDesc=0&_odkw=3080&_osacat=0");
        ...
        <div>
            ...
            <%
            	...
            	precio = versus.VsBusqueda("https://www.vsgamers.es/product/tarjeta-grafica-asus-rog-strix-geforce-rtx-3070-v2-gaming-oc-8g-8-gb-gddr6x-lhr");
